package eu.modelwriter.architecture.textconnectors.docx.command.ui.util.plugin;
...
import eu.modelwriter.architecture.textconnectors.docx.command.ui.util.plugin.WorkbenchSelector;
