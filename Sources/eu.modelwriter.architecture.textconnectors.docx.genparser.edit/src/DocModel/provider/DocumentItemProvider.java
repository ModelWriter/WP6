...
/**
 * This is the item provider adapter for a {@link DocModel.Document} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DocModelPackage.Literals.DOCUMENT__PATH,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DocModelPackage.Literals.DOCUMENT__OWNED_PARAGRAPH);
			childrenFeatures.add(DocModelPackage.Literals.DOCUMENT__OWNED_MARK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DocModelPackage.Literals.DOCUMENT__OWNED_PARAGRAPH,
				 DocModelFactory.eINSTANCE.createParagraph()));

		newChildDescriptors.add
			(createChildParameter
				(DocModelPackage.Literals.DOCUMENT__OWNED_MARK,
				 DocModelFactory.eINSTANCE.createMark()));
	}
