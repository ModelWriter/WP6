 ...
 * @generated
 */
public class ReqModelViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ReqModel.diagram.edit.parts.ProductEditPart.MODEL_ID.equals(op
				.getSemanticHint())
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(ReqModel.diagram.edit.parts.ProductEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case ReqModel.diagram.edit.parts.RequirementLevelEditPart.VISUAL_ID:
			return createRequirementLevel_2001(domainElement, containerView,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case ReqModel.diagram.edit.parts.RequirementRefineEditPart.VISUAL_ID:
			return createRequirementRefine_4001(containerView, index,
					persisted, preferencesHint);
		case ReqModel.diagram.edit.parts.RequirementDependencyToEditPart.VISUAL_ID:
			return createRequirementDependencyTo_4002(containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createRequirementLevel_2001(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createRequirement_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createRequirement_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Edge createRequirementRefine_4001(View containerView, int index,
		...
		edge.setType(ReqModel.diagram.part.ReqModelVisualIDRegistry
		...
		Node label6001 = createLabel(
				edge,
				ReqModel.diagram.part.ReqModelVisualIDRegistry
						.getType(ReqModel.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createRequirementDependencyTo_4002(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6002 = createLabel(
				edge,
				ReqModel.diagram.part.ReqModelVisualIDRegistry
						.getType(ReqModel.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ReqModel.diagram.edit.parts.ProductEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", ReqModel.diagram.edit.parts.ProductEditPart.MODEL_ID); //$NON-NLS-1$
