 ...
 * @generated
 */
public class RequirementLevel2ItemSemanticEditPolicy extends
		ReqModel.diagram.edit.policies.ReqModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public RequirementLevel2ItemSemanticEditPolicy() {
		super(
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit
					...
					case ReqModel.diagram.edit.parts.Requirement2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it
							...
							if (ReqModel.diagram.part.ReqModelVisualIDRegistry
									.getVisualID(incomingLink) == ReqModel.diagram.edit.parts.RequirementRefineEditPart.VISUAL_ID) {
							...
							if (ReqModel.diagram.part.ReqModelVisualIDRegistry
									.getVisualID(incomingLink) == ReqModel.diagram.edit.parts.RequirementDependencyToEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										incomingLink.getSource().getElement(),
										null, incomingLink.getTarget()
												.getElement(), false);
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
							...
							if (ReqModel.diagram.part.ReqModelVisualIDRegistry
									.getVisualID(outgoingLink) == ReqModel.diagram.edit.parts.RequirementRefineEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
							...
							if (ReqModel.diagram.part.ReqModelVisualIDRegistry
									.getVisualID(outgoingLink) == ReqModel.diagram.edit.parts.RequirementDependencyToEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(),
										null, outgoingLink.getTarget()
												.getElement(), false);
