...
public class ProductCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ReqModel.ReqModelPackage.eINSTANCE.getProduct_OwnedDefinition();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ReqModel.diagram.part.ReqModelNodeDescriptor> childDescriptors = ReqModel.diagram.part.ReqModelDiagramUpdater
				.getProduct_1000SemanticChildren(viewObject);
		for (ReqModel.diagram.part.ReqModelNodeDescriptor d : childDescriptors) {
	...
	protected boolean isOrphaned(Collection<EObject> semanticChildren,
			final View view) {
		if (isShortcut(view)) {
			return ReqModel.diagram.part.ReqModelDiagramUpdater
	...
	protected void refreshSemantic() {
		...
		for (View v : getViewChildren()) {
			if (isShortcut(v)) {
				if (ReqModel.diagram.part.ReqModelDiagramUpdater
		...
		for (Iterator<ReqModel.diagram.part.ReqModelNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			ReqModel.diagram.part.ReqModelNodeDescriptor next = descriptorsIterator
					.next();
			String hint = ReqModel.diagram.part.ReqModelVisualIDRegistry
		...
		for (ReqModel.diagram.part.ReqModelNodeDescriptor next : childDescriptors) {
			String hint = ReqModel.diagram.part.ReqModelVisualIDRegistry
					.getType(next.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<ReqModel.diagram.part.ReqModelLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = ReqModel.diagram.part.ReqModelVisualIDRegistry
			...
			for (Iterator<ReqModel.diagram.part.ReqModelLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				ReqModel.diagram.part.ReqModelLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<ReqModel.diagram.part.ReqModelLinkDescriptor> collectAllLinks(
		...
		case ReqModel.diagram.edit.parts.RequirementLevelEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ReqModel.diagram.part.ReqModelDiagramUpdater
						.getRequirementLevel_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case ReqModel.diagram.edit.parts.RequirementLevel2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ReqModel.diagram.part.ReqModelDiagramUpdater
						.getRequirementLevel_3001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
	...
	private Collection<IAdaptable> createConnections(
			Collection<ReqModel.diagram.part.ReqModelLinkDescriptor> linkDescriptors,
			Domain2Notation domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (ReqModel.diagram.part.ReqModelLinkDescriptor nextLinkDescriptor : linkDescriptors) {
