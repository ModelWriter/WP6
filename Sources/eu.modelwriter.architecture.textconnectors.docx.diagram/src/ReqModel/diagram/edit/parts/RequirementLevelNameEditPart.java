 ...
 * @generated
 */
public class RequirementLevelNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RequirementLevelNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ReqModel.diagram.edit.policies.ReqModelTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ReqModel.diagram.providers.ReqModelParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ReqModel.diagram.edit.parts.ReqModelEditPartFactory
