...
public class RequirementLevelRequirementLevelOwnedDefinitionCompartmentEditPart
	...
	public String getCompartmentName() {
		return ReqModel.diagram.part.Messages.RequirementLevelRequirementLevelOwnedDefinitionCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ReqModel.diagram.edit.policies.RequirementLevelRequirementLevelOwnedDefinitionCompartmentItemSemanticEditPolicy());
		installEditPolicy(
		...
		installEditPolicy(
				...
				new ReqModel.diagram.edit.policies.RequirementLevelRequirementLevelOwnedDefinitionCompartmentCanonicalEditPolicy());
	}
