 ...
 * @generated
 */
public class RequirementLevelEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RequirementLevelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ReqModel.diagram.edit.policies.RequirementLevelItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ReqModel.diagram.edit.parts.RequirementLevelNameEditPart) {
			((ReqModel.diagram.edit.parts.RequirementLevelNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRequirementLevelLabelFigure());
			return true;
		}
		if (childEditPart instanceof ReqModel.diagram.edit.parts.RequirementLevelRequirementLevelOwnedDefinitionCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getRequirementLevelOwnedDefinitionCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ReqModel.diagram.edit.parts.RequirementLevelRequirementLevelOwnedDefinitionCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ReqModel.diagram.edit.parts.RequirementLevelRequirementLevelOwnedDefinitionCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getRequirementLevelOwnedDefinitionCompartmentFigure();
			pane.remove(((ReqModel.diagram.edit.parts.RequirementLevelRequirementLevelOwnedDefinitionCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ReqModel.diagram.edit.parts.RequirementLevelRequirementLevelOwnedDefinitionCompartmentEditPart) {
