...
public class Requirement2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ReqModel.diagram.edit.policies.Requirement2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ReqModel.diagram.edit.parts.RequirementName2EditPart) {
			((ReqModel.diagram.edit.parts.RequirementName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureRequirementLabelFigure());
			return true;
		}
		return false;
	}
	...
	public class RequirementFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureRequirementLabelFigure = new WrappingLabel();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureRequirementLabelFigure() {
