...
public class RequirementEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ReqModel.diagram.edit.policies.RequirementItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ReqModel.diagram.edit.parts.RequirementNameEditPart) {
			((ReqModel.diagram.edit.parts.RequirementNameEditPart) childEditPart)
