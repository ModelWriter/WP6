 ...
 * @generated
 */
public class ParseTreeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ParseTreePackage.DOCUMENTATION: {
			...
			case ParseTreePackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParseTreePackage.NODE: {
			...
			case ParseTreePackage.DOCUMENT: {
			...
			case ParseTreePackage.NAMED_ELEMENT: {
			...
			case ParseTreePackage.NAMED_NODE: {
