 ...
 * <ul>
 *   <li>{@link ParseTree.impl.DocumentationImpl#getText <em>Text</em>}</li>
 *   <li>{@link ParseTree.impl.DocumentationImpl#getTextFormat <em>Text Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentationImpl extends ElementImpl implements Documentation {
	...
	protected EClass eStaticClass() {
		return ParseTreePackage.Literals.DOCUMENTATION;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParseTreePackage.DOCUMENTATION__TEXT, oldText, text));
	}
	...
	public void setTextFormat(String newTextFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParseTreePackage.DOCUMENTATION__TEXT_FORMAT, oldTextFormat, textFormat));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ParseTreePackage.DOCUMENTATION__TEXT:
				return getText();
			case ParseTreePackage.DOCUMENTATION__TEXT_FORMAT:
