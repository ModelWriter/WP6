 ...
 * @generated
 */
public class DocModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DocModelPackage.MARK: {
				Mark mark = (Mark)theEObject;
				T result = caseMark(mark);
				if (result == null) result = caseElement(mark);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DocModelPackage.PARAGRAPH: {
			...
			case DocModelPackage.PART: {
				...
				if (result == null) result = caseNode(part);
