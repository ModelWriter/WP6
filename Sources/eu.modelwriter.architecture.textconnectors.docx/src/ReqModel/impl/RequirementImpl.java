...
public class RequirementImpl extends DefinitionImpl implements Requirement {
	...
	protected EClass eStaticClass() {
		return ReqModelPackage.Literals.REQUÝREMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqModelPackage.REQUÝREMENT__ID, oldId, ýd));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqModelPackage.REQUÝREMENT__DESCRÝPTÝON, oldDescription, description));
	}
	...
	public Requirement getRefine() {
		if (refine != null && refine.eIsProxy()) {
			...
			if (refine != oldRefine) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReqModelPackage.REQUÝREMENT__REFÝNE, oldRefine, refine));
			}
		}
		return refine;
	}
	...
	public void setRefine(Requirement newRefine) {
		...
		refine = newRefine;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqModelPackage.REQUÝREMENT__REFÝNE, oldRefine, refine));
	}
	...
	public Requirement getDependencyTo() {
		if (dependencyTo != null && dependencyTo.eIsProxy()) {
			...
			if (dependencyTo != oldDependencyTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReqModelPackage.REQUÝREMENT__DEPENDENCY_TO, oldDependencyTo, dependencyTo));
			}
		}
		return dependencyTo;
	}
	...
	public void setDependencyTo(Requirement newDependencyTo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqModelPackage.REQUÝREMENT__DEPENDENCY_TO, oldDependencyTo, dependencyTo));
	}
	...
	public void setPriorityType(Priority newPriorityType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqModelPackage.REQUÝREMENT__PRÝORÝTY_TYPE, oldPriorityType, priorityType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ReqModelPackage.REQUÝREMENT__REFÝNE:
				if (resolve) return getRefine();
				return basicGetRefine();
			case ReqModelPackage.REQUÝREMENT__DEPENDENCY_TO:
