...
public class RequirementLevelImpl extends DefinitionImpl implements RequirementLevel {
	...
	protected EClass eStaticClass() {
		return ReqModelPackage.Literals.REQUÝREMENT_LEVEL;
	}
	...
	public EList<Definition> getOwnedDefinition() {
		if (ownedDefinition == null) {
			ownedDefinition = new EObjectContainmentEList<Definition>(Definition.class, this, ReqModelPackage.REQUÝREMENT_LEVEL__OWNED_DEFÝNÝTÝON);
		}
