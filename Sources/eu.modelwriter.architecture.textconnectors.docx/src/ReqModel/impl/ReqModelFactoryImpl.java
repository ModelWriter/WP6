 ...
 * @generated
 */
public class ReqModelFactoryImpl extends EFactoryImpl implements ReqModelFactory {
	/**
	 ...
	 * @generated
	 */
	public static ReqModelFactory init() {
		try {
			ReqModelFactory theReqModelFactory = (ReqModelFactory)EPackage.Registry.INSTANCE.getEFactory(ReqModelPackage.eNS_URI);
			if (theReqModelFactory != null) {
				return theReqModelFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new ReqModelFactoryImpl();
	}
	 ...
	 * @generated
	 */
	public ReqModelPackage getReqModelPackage() {
		return (ReqModelPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static ReqModelPackage getPackage() {
		return ReqModelPackage.eINSTANCE;
	}
