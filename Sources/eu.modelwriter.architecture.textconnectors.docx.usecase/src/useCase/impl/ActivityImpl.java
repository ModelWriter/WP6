 ...
 * <ul>
 *   <li>{@link useCase.impl.ActivityImpl#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivityImpl extends FlowNodeImpl implements Activity {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UseCasePackage.ACTÝVÝTY__DESCRÝPTÝON, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UseCasePackage.ACTÝVÝTY__DESCRÝPTÝON:
